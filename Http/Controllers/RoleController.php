...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("business.settings.users-management.roles.list", compact('permissions','groups', 'roles'));
    }
    ...
    public function add()
    {
        ...
        return view("business.settings.users-management.roles.add", compact('permissions', 'groups', 'roles'));
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view("business.settings.users-management.roles.edit", compact('permissions', 'groups', 'singlerole', 'existingPermissions'));
    }
